#=============================================================================================================================
#
# Script:           W11OSDStartDev.ps1
# Generated by:     Configure Windows Autopilot Branding
...
# Updates
$UpdateNews = @(
"20.06.2025 [TEST] Windows 11 OS Deployment"
)
...
Write-Host -ForegroundColor DarkBlue $SL
Write-Host -ForegroundColor Blue "[$($DT)] [PostOS] Download custom stuff"
Write-Host -ForegroundColor DarkBlue $SL

# Copy CMTrace.exe local
Write-Host -ForegroundColor Cyan "`n[$($DT)] [PostOS] Download and copy cmtrace file"
...
Write-Host -ForegroundColor Cyan "`n[$($DT)] [PostOS] Download and copy sigvaris.bmp file"
...
Write-Host -ForegroundColor Cyan "`n[$($DT)] [PostOS] Download and copy WirelessConnect.exe file"
