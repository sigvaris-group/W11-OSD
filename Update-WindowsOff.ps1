#=============================================================================================================================
#
# Script Name:     Update-WindowsOff.ps1
# Description:     Install Windows Updates for Offline Image
# Created:         06/18/2025
# Version:         3.0
#
#=============================================================================================================================

$Title = "Install Windows Updates for Offline Image"
...
try {
    ...
    If ($OSDWindowsUpdate -eq "Yes") {                
        ...
        Install-WindowsUpdate -KBArticleID KB5063060 -ForceInstall -AcceptAll -IgnoreReboot
