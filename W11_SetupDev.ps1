...
try {
    ...
    #===================================================================================================================================================
    Write-Host -ForegroundColor Gray "[$($DT)] [Branding] Injecting RAID Drivers into WinRE to resolve Remote Wipe issue"
    ...
    Else {
        Write-Host -ForegroundColor Red "[$($DT)] [Branding] Invalid quantity of drivers detected. Expected value is 1."
        $StorageDriver
    }
